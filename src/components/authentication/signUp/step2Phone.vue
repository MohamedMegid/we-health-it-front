          ...
          <div class="mt-3">
            ...
            <div v-if="!sendCode" class="send code">
              ...
              <div class="input-group mb-3">
                ...
                <div
                  v-if="
                    !$v.form.phoneNumber.required && $v.form.phoneNumber.$error
                  "
                  class="invalid-feedback"
                >
                ...
                <div
                  v-else-if="
                    !$v.form.phoneNumber.valid && $v.form.phoneNumber.$error
                  "
                  class="invalid-feedback"
                >
                ...
                >
                  {{
                    maxLengthError(
                      $t("phoneNumber.label"),
                      $v.form.phoneNumber.$params.maxLen.max
                    )
                  }}
                </div>
                ...
                >
                  {{
                    minLengthError(
                      $t("phoneNumber.label"),
                      $v.form.phoneNumber.$params.minLen.min
                    )
                  }}
                </div>
