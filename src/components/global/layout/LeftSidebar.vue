    ...
    <div class="app-sidebar">
      <div class="side-header">
        <a class="header-brand1" href="index.html">
          ...
          />
          <img
            src="/template/assets/images/brand/logo-1.png"
            class="header-brand-img toggle-logo"
            alt="logo"
          />
          <img
            src="/template/assets/images/brand/logo-2.png"
        ...
        <ul class="side-menu">
              ...
              <div class="mega-menu">
                <div class="">
                  <ul>
                    ...
                    <li>
                      <a href="dropdown.html" class="slide-item"> Dropdowns</a>
                    </li>
                  </ul>
                </div>
                <div class="">
          ...
          <li>
            <a
              ...
              ><span class="badge bg-green br-5 side-badge blink-text pb-1"
                >New</span
              ></a
            >
          </li>
            ...
            <ul class="slide-menu">
              ...
              <li class="sub-slide">
                ...
                <ul class="sub-slide-menu">
                  ...
                  <li>
                    <a href="form-input-spinners.html" class="sub-slide-item">
              ...
              <li class="sub-slide">
                ...
                <ul class="sub-slide-menu">
                  ...
                  <li>
                    <a href="extension-tables.html" class="sub-slide-item">
                      Extension Tables</a
                    >
                  </li>
                </ul>
              ...
              <li>
                <a href="switcher-1.html" class="slide-item"> Switcher</a>
              </li>
            </ul>
          </li>
          <li class="slide">
