<template>
  ...
  <div class="app-header header sticky">
    <div class="container-fluid main-container"
      :class="{'background-white':!sashdarkMode}"
    >
      <div class="d-flex">
        <a
        ...
        <a class="logo-horizontal" href="index.html">
          <img
            src="/template/assets/images/brand/logo.png"
            class="header-brand-img desktop-logo"
            alt="logo"
          />
          <img
            src="/template/assets/images/brand/logo-3.png"
        ...
        <div class="d-flex order-lg-2 ms-auto header-right-icons">
          ...
          <div class="navbar navbar-collapse responsive-navbar p-0">
            <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
              <div class="d-flex flex-wrap py-sm-0 py-2 order-lg-2">
                    ...
                    <div class="header-dropdown-list message-menu">
                      <div class="dropdown-item d-flex p-4">
                        ...
                        <span
                          ...
                          data-bs-image-src="/template/assets/images/pngs/4.jpg"
                        ></span>
                        <div class="wd-50p">
                      ...
                      <div class="dropdown-item d-flex p-4">
                        ...
                        <span
                          class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                          data-bs-image-src="/template/assets/images/pngs/6.jpg"
                        ></span>
                        <div class="wd-50p">
                      ...
                      <div class="dropdown-item d-flex p-4">
                        ...
                        <span
                          class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                          data-bs-image-src="/template/assets/images/pngs/8.jpg"
                        ></span>
                        <div class="wd-50p">
                      ...
                      <div class="dropdown-item d-flex p-4">
                        ...
                        <span
                          class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                          data-bs-image-src="/template/assets/images/pngs/1.jpg"
                        ></span>
                        <div class="wd-50p">
                      ...
                      <div class="dropdown-item d-flex p-4">
                        ...
                        <span
                          class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                          data-bs-image-src="/template/assets/images/pngs/3.jpg"
                        ></span>
                        <div class="wd-50p">
                    ...
                    <div class="message-menu message-menu-scroll">
                      <a class="dropdown-item d-flex" href="chat.html">
                        <span
                          ...
                          data-bs-image-src="/template/assets/images/users/1.jpg"
                        ></span>
                        <div class="wd-90p">
                          <div class="d-flex">
                      ...
                      <a class="dropdown-item d-flex" href="chat.html">
                        <span
                          class="avatar avatar-md brround me-3 align-self-center cover-image"
                          data-bs-image-src="/template/assets/images/users/15.jpg"
                        ></span>
                        <div class="wd-90p">
                          <div class="d-flex">
                      ...
                      <a class="dropdown-item d-flex" href="chat.html">
                        <span
                          class="avatar avatar-md brround me-3 align-self-center cover-image"
                          data-bs-image-src="/template/assets/images/users/12.jpg"
                        ></span>
                        <div class="wd-90p">
                          <div class="d-flex">
                      ...
                      <a class="dropdown-item d-flex" href="chat.html">
                        <span
                          class="avatar avatar-md brround me-3 align-self-center cover-image"
                          data-bs-image-src="/template/assets/images/users/4.jpg"
                        ></span>
                        <div class="wd-90p">
                          <div class="d-flex">
                      ...
                      <a class="dropdown-item d-flex" href="chat.html">
                        <span
                          class="avatar avatar-md brround me-3 align-self-center cover-image"
                          data-bs-image-src="/template/assets/images/users/3.jpg"
                        ></span>
                        <div class="wd-90p">
                          <div class="d-flex">
                ...
                <div class="dropdown d-flex profile-1">
                  <a
                    href="javascript:void(0)"
                    data-bs-toggle="dropdown"
                    class="nav-link leading-none my-custom-avatar d-flex"
                  >
                    <img
                      src="@/assets/user.jpg"
                      alt="profile-user"
...
export default {
  ...
  data(){
    return {
      sashdarkMode: localStorage.getItem("sashdarkMode")
    }
  },
};
</script>
